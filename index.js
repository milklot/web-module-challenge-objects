...
createMenuItem('borsch', 8, "soup");
createMenuItem('steak', 20, "dinner");
createMenuItem('mashed potatoes', 8, "soup");
...
function getLastReview(arr) {
    ...
    return `${arr[len].name} gave the restaurant a ${arr[len].rating}, and their feedback was: ${arr[len].feedback}`
}
